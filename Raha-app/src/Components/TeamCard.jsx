...
export const TeamCard = ({ Team, Name, Title, Social }) => {
  return (
    <div className="border-tetiary border-2 hover-shadow hover:shadow-lg hover:border-0 pb-5 px-10">
      ...
      <div className="px-1 md:px-5 py-1 pt-3 md:pt-5">
        <button className="bg-secondary text-black px-6 md:px-8 py-2 md:py-4 text-lg md:text-xl font-medium rounded-full">{Social}</button>
      </div>
    </div>
  );
};
