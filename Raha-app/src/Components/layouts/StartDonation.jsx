  ...
  return (
    <div className="relative items-center p-25 bg-neutral">
      <div>
        ...
        <p className="font-medium md:font-semibold mx-auto text-center text-2xl md:text-3xl p-2 max-w-sm md:max-w-xl">
          Transparent Donations: See How You Make a Difference
        </p>
      </div>
      <div className="flex md:flex-row flex-col gap-10 pt-10 items-center justify-center mx-5 md:mx-20">
      ...
      <div>
        <img className="absolute -left-20 top-0 md:left-0 md:top-0" src="/Donation-leaf-left.svg" />
        <img className="absolute -right-20 top-0 md:right-0 md:top-0" src="/Donation-leaf-right.svg"/>
      </div>
    </div>
  );
}; 
